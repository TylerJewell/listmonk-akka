...
A `LICENSE-listmonk` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [knadh/listmonk](https://github.com/knadh/listmonk), Copyright
the knadh/listmonk authors, licensed under AGPL-3.0. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../listmonk-port/specs/SPEC-001-listmonk.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
